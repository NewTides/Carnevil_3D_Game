...
public class PlayerController : MonoBehaviour
{
	...
	private void CheckActivity(Collider other)
	{
		...
		if ((area1Activity == 120 && other.name == "Area1") || (area2Activity == 120 && other.name == "Area2") || (area3Activity == 120 && other.name == "Area3") || (area4Activity == 120 && other.name == "Area4"))
		{
			description = "Ghost activity in the local area ('" + other.name + "') is currently moderate but rising.";
			print(description);
		}
		if ((area1Activity == 180 && other.name == "Area1") || (area2Activity == 180 && other.name == "Area2") || (area3Activity == 180 && other.name == "Area3") || (area4Activity == 180 && other.name == "Area4"))
		{
